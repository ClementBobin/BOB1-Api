        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleSlots_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleSlots_Users_AssignedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subscriptions_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointRules_Role",
                table: "PointRules",
                column: "Role",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RoleSlots_AssignedUserId",
                table: "RoleSlots",
                column: "AssignedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RoleSlots_MatchId_Role",
                table: "RoleSlots",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_UserId_MatchId",
                table: "Subscriptions",
                columns: new[] { "UserId", "MatchId" },
                unique: true);
